...
#                  if math.cos(r) > 0:          if math.cos(k + r):
...
#           It is a variable name, it normally indicates something you do not need to worry about
...
#                   The second one is wrong because the diameter and radius are increasing at different rates
#              x = starting_point.x
#              for k in range(n):
