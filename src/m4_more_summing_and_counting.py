...
def run_test_count_cosines_from():
    ...
    answer_from_my_code = count_cosines_from(3,9,0.27)
    print('Test 3 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)

    # Test 4:
    answer_from_oracle = 4
    answer_from_my_code = count_cosines_from(4,8,-0.5)
    print('Test 4 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.48926  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 15)
